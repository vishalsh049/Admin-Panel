...
const Banner = sequelize.define(
  "Banner",
  {
    ...
    mobile_image_path: { type: DataTypes.STRING, allowNull: true, field: "mobile_image_path" },
    description: { type: DataTypes.TEXT, allowNull: true },
    device: { type: DataTypes.STRING, allowNull: false, defaultValue: "all" },
    open_new_tab: { type: DataTypes.BOOLEAN, defaultValue: false, field: "open_new_tab" },
    view_count: { type: DataTypes.INTEGER, defaultValue: 0, field: "view_count" },
    click_count: { type: DataTypes.INTEGER, defaultValue: 0, field: "click_count" },
